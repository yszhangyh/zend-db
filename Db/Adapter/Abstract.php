...
abstract class Zend_Db_Adapter_Abstract
{
    ...
    public function setProfiler($profiler)
    {
        ...
        if ($profilerInstance === null) {
            if (!class_exists($profilerClass, $_autoload=false)) {
    ...
    public function updates($table, array $bind, $where = '')
    {
        /**
         * Build "col = ?" pairs for the statement,
         * except for Zend_Db_Expr which is treated literally.
    ...
    public function quote($value, $type = null)
    {
        ...
        if ($type !== null && array_key_exists($type = mb_strtoupper($type), $this->_numericDataTypes)) {
            $quotedValue = '0';
    ...
    public function foldCase($key)
    {
        switch ($this->_caseFolding) {
            case Zend_Db::CASE_LOWER:
                ...
                break;
            case Zend_Db::CASE_UPPER:
                $value = mb_strtoupper((string) $key);
                break;
            case Zend_Db::CASE_NATURAL:
            default:
                $value = (string) $key;
